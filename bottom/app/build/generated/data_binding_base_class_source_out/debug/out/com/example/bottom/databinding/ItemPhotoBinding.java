...
public final class ItemPhotoBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgSlide1;

  private ItemPhotoBinding(@NonNull LinearLayout rootView, @NonNull ImageView imgSlide1) {
  ...
  public static ItemPhotoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.img_slide1;
      ImageView imgSlide1 = ViewBindings.findChildViewById(rootView, id);
      if (imgSlide1 == null) {
        break missingId;
      }

      return new ItemPhotoBinding((LinearLayout) rootView, imgSlide1);
    }
